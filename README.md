...
bakabt_auto-login_prune-prevention.py is a cli way to log into your BakaBT account to prevent pruning; you can set up a crontab entry and have it run once a day to log you in.  This is a Python script.
